...
@router.get("/counsel/application", summary="상담 신청", response_model=schema.CounselApplicationResponse)
def create_counsel_application(
    request: schema.CounselApplicationRequest = Depends(schema.CounselApplicationRequest),
